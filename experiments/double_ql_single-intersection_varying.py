...
if __name__ == '__main__':
    ...
    if args.test_flow:
        folder = str(Path('./outputs/constant/flow/dql_varying/new_state_{}_flow_{}_{}_{}_new_state{}_varying/'.format(args.state,args.flow_ns*3600,args.flow_ew*3600,args.explore_strategy,args.new_state)))
